...
The 4xT10 rows below were measured on four 16 GiB Tesla T10 GPUs over PCIe
(TP=4), using pre4 `315d5930f5` plus the PCIe CAR fix from
[#153](https://github.com/weicj/vLLM-2080Ti-Definitive/pull/153)
(`a910fe9e43`). They require that ABI-matched extension; unpatched pre4 is not
an equivalent route. All four runs left custom all-reduce enabled and logged
...
TQK8V4 route received a separate 4K/128 warmup before measurement and used
FlashInfer FA2 on SM75. The fast FP16 MTP3 candidate is not listed below: its
full-graph quality probe failed (0/32 GSM8K versus 21/32 for normal FP16, plus
failed retrieval, multi-turn, and image OCR) and it must remain experimental.
The image smoke validates visual request routing and generation, not
...
| Profile | Mode | Context | KV | MTP | Messages | GPU KV tokens | Performance |
|---|---|---:|---|---:|---|---:|---:|
| `2x2080Ti/qwen27b/w4a16/fast/dflash2-tqk8v4-2x172k-text-only.env` | fast | 172K x2 | TQK8V4 | DFlash2/7 | text-only | 369,439 | validated |
| `2x2080Ti/qwen27b/w4a16/fast/dflash2-tqk8v4-1x256k-text-image.env` | fast | 256K x1 | TQK8V4 | DFlash2/7 | text+image | 318,010 | validated |
...
|---|---|---:|---|---:|---:|---:|---:|---:|---|
| `2x2080Ti/qwen27b/w4a16/normal/nomtp-fp8kv-1x192k-text-only.env` | normal | 192K | FP8 / 0 | 518,191 | 1372.1 / 42.0 | 1507.4 / 80.4 | 1535.9 / 152.0 | 1523.4 / 270.8 | full-window run |
| `2x2080Ti/qwen27b/w4a16/fast/mtp-tq4nc-1x262k-text-only.env` | fast | 262K | TQ4NC / 3 | 732,381 | 1402.9 / 103.5 | 1449.1 / 180.4 | 1460.0 / 220.7 | 1449.1 / 347.3 | full-window run |
