...
| `qwen27b/w4a16/fast/dflash2-tqk8v4-1x256k-text-image.env` | fast | 256K x1 | TQK8V4 | DFlash2/7 | text+image | 318,010 | 尚未测吞吐 |
...
256K 多模态路线已完成启动、多模态健康检查和容量验证，但目前没有可比的图像吞吐
实测，因此不把纯文本合成测试数据归到该路线名下。
