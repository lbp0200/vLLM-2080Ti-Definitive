...
VLLM_ALLOW_MAMBA_SPEC_FULL_CUDAGRAPH|SPECULATIVE_DRAFT_SAMPLE_METHOD)
      return 0
      ;;
    *)
      return 1
...
SPECULATIVE_CONFIG|SPECULATIVE_KV_CACHE_DTYPE|ATTENTION_BACKEND|DISABLE_HYBRID_KV_CACHE_MANAGER|\
